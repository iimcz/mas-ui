...
<div class="container h-full mx-auto flex justify-center">
    <div class="flex w-5/6 space-y-5 flex-col m-4">
        ...
        <div class="text-center grid grid-cols-3 gap-2">
            <EmulatorCard on:select={(e) => {searchText = e.detail.title}} title="Atari 800" image={img} description="Krátký popis" />
            <EmulatorCard on:select={(e) => {searchText = e.detail.title}} title="Atari 400" image={img} description="Krátký popis" />
        </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="/wizard/emulator" class="btn variant-filled">Vybrat</a></td>
                    </tr>
                    <tr>
                        <td>Atari 400</td>
                        <td><button class="btn variant-filled">Detail</button></td>
