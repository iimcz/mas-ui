...
<Dialog>
    <Dialog.Trigger
        class="flex gap-2 card preset-outlined-primary-300-700 p-4 transition-transform hover:scale-105"
    >
        <div class="mr-4 ml-2 flex items-center justify-center">
            <Fa size="lg" scale="2" class="w-full" icon={faUpload} />
        </div>
        <div class="text-left">
            <div class="text-lg font-bold">Nahrát soubor</div>
            <div>Nahrajte existující soubor</div>
        </div>
    </Dialog.Trigger>
    <Portal>
        ...
        <Dialog.Positioner class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <Dialog.Description>
                    <form class="form">
                        {#if uploading}
                            <div class="flex flex-col gap-4 pb-4 font-semibold">
                ...
                {#if !uploading}
                    <footer class="flex justify-end gap-2">
                        ...
                        <button
                            ...
                            onclick={onFormSubmit}>Nahrát</button
                        >
                    </footer>
                {/if}
            </Dialog.Content>
